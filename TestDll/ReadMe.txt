========================================================================
    ACTIVE TEMPLATE LIBRARY : TestDll Project Overview
========================================================================

AppWizard has created this TestDll project for you to use as the starting point for
...
TestDll.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (TestDll.h)
        GUID definitions                                (TestDll_i.c)
        A type library                                  (TestDll.tlb)
        Marshaling code                                 (TestDll_p.c and dlldata.c)

TestDll.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in TestDll.idl. It will be regenerated by MIDL during compilation.
...
TestDllps.vcxproj
	...
	dlldata.c, TestDll_i.c and TestDll_p.c which are required
	to build the proxy/stub DLL.

TestDllps.vcxproj.filters
